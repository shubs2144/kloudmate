...
const multiSeriesData = [
  ...
  { label: 'label with numbers 12345', value: 5432.10 },
  { label: 'testing with a moderately size', value: 678.90 }
];
  ...
  return (
    <div className="bg-gray-900 text-white p-4 min-h-screen">
      ...
      <ResponsiveGridLayout
        ...
        margin={[16, 16]}
      >
        <div key="single" className="bg-gray-800 rounded-md overflow-hidden items-center">
